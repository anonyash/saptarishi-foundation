    ...
    <footer className="border-t border-border px-6 py-12">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-8 md:flex-row">
        <div className="flex items-center gap-3">
          ...
          <span className="font-serif text-lg font-semibold">Saptarishi Foundation</span>
        </div>
        ...
        <div className="flex gap-6 text-xs uppercase tracking-tighter">
          ...
          <Link to="/volunteer" className="transition-colors hover:text-primary">Volunteer</Link>
          <Link to="/donate" className="transition-colors hover:text-primary">Donate</Link>
        </div>
      </div>
    </footer>
  );
